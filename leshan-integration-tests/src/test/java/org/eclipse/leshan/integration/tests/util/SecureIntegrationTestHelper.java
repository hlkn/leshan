...
public class SecureIntegrationTestHelper extends IntegrationTestHelper {
    ...
    @Override
    protected org.eclipse.leshan.server.californium.endpoint.CaliforniumEndpointsProvider.Builder createEndpointsProviderBuilder() {
        org.eclipse.leshan.server.californium.endpoint.CaliforniumEndpointsProvider.Builder builder = super.createEndpointsProviderBuilder();
        Configuration configuration = builder.createDefaultCoapServerConfiguration();
        ...
        builder.setCoapServerConfiguration(configuration);
